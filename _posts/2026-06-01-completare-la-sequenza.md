...
---
Di recente Andrej Karpathy, uno dei ricercatori più noti nel campo dell'intelligenza artificiale, ha pubblicato un codice di circa duecento righe che implementa da zero un modello linguistico. Nessuna libreria, nessun framework: solo la logica essenziale di come funzionano questi sistemi.
